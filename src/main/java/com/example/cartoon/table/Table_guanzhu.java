...
import com.example.cartoon.adapter.Table_Guanzhu_Baseadapter;
...
public class Table_guanzhu extends Fragment {
    private View view;
    ...
    private int type = 1;
    //    给Bean包设置一个集合
    private List<Table_Guanzhu_Mybean.DataBean> list = new ArrayList<>();
...
//    private String path= "http://v.juhe.cn/toutiao/index?type=top&key=10f42a5d2a9757f889a4d0d3bcacfc51";
    ...
    private Table_Guanzhu_Baseadapter adapter;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.table_guanzhu, container, false);
        initView(view);
        //        设置上拉加载
...
//解析
        ...
        protected void onPostExecute(String s) {
            ...
            Gson gson = new Gson();
            Table_Guanzhu_Mybean myBean = gson.fromJson(s, Table_Guanzhu_Mybean.class);
    ...
    public void setAdapter() {
        if (adapter == null) {
            ...
            adapter = new Table_Guanzhu_Baseadapter(getActivity(),list);
    ...
    private void initView(View view) {
        x_list = (XListView) view.findViewById(R.id.table_Guanzhu_Xlist);
    }
}
